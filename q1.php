...
$op = $_GET['answer'];
$sql = "SELECT * FROM option WHERE opID = '$op' ";
    ...
    <div class="container">
        ...
        <?php
                            while($row = mysqli_fetch_array($sql_run) ){
                                $nextID = $row['nextID'];
                                $sql1 = "SELECT * FROM question WHERE quesID = '$nextID' ";
                                $sql_run1 = mysqli_query($db,$sql1);
                                while($row = mysqli_fetch_array($sql_run1) ){
                                    $ques = $row['quesDes'];
                                    $quesID = $row['quesID'];
                        ...
                        ?>
            <div class="col-lg-4 col-md-6  myImg">
            <?php
                if($quesType == "1"){
            ?>
                    <picture>    
                            <source media="(max-width: 699px)" srcset="img/anime/cat4.png" style= "width:1%; height:auto;">
                            <source media="(min-width: 700px)" srcset="img/anime/png/10-point-2.png">
                            <img src="img/anime/png/10-point-2.png" alt="doctor">
                    </picture>
            <?php
                }else if($quesType == "2"){                          
            ?> 
                    <picture>    
                        <source media="(max-width: 699px)" srcset="img/anime/cat4.png" style= "width:1%; height:auto;">
                        <source media="(min-width: 700px)" srcset="img/anime/png/45-note-2.png">
                        <img src="img/anime/png/45-note-2.png" alt="doctor">
                    </picture>
            <?php
                }else if($quesType == "3"){ 
            ?>
                    <picture>    
                        <source media="(max-width: 699px)" srcset="img/anime/confused.png" style= "width:1%; height:auto;">
                        <source media="(min-width: 700px)" srcset="img/anime/png/26-oops.png">
                        <img src="img/anime/png/26-oops.png" alt="doctor">
                    </picture>
            <?php
                    }else if($quesType == "0"){ 
            ?>
            <picture>    
                        <source media="(max-width: 699px)" srcset="img/anime/cat4.png" style= "width:1%; height:auto;">
                        <source media="(min-width: 700px)" srcset="img/anime/png/86-search.png">
                        <img src="img/anime/doc1.png" alt="doctor">
                    </picture>
            <?php
                     }
            ?>
            ...
            <div class="col-lg-8 col-md-6 my8">
                <div class="privew">
                    <div class="questionsBox">
                        <form action="q1.php" method="GET"></form>
                        
                            <div class="questions"><?= $ques ?> </div>
                        <?php
                                }
                            }
                        ?>
                                ...
                                <ul class="answerList">
                                <?php
                                      $sql2 = "SELECT * FROM option WHERE quesID = '$nextID' ";
                                ...
                                ?>
                                    <li>
                                        <label>
                                            <input type="radio" name="answer" value="<?= $opID ?>" > <?= $options ?> </label>
                                    </li>
                                ...
                                ?>
                                    ...
                                    <div class="questionsRow">
                                        <div class="row">
                                            <div class="col-6">
                                                <button type="button" class="btn btn-primary btn-lg btn-block" onClick = "javascript:history.go(-1)">Go Back</button>
                                            </div>
                                            <div class="col-6">
        ...
        <div class="row">
            <div class="col-8">
                <h6><strong><h3>Disclaimer</h3><br>
                    This website is intended as a guide only. It helps you to decide how quickly you should seek veterinary attention for your pet. If you are in any doubt over your pet's condition, telephone your vet for advice. It is intended for use in Australia.<br>

                    If your pet's symptoms are not on the site and you are worried about your pet, contact your vet for advice.</strong></h6>
            </div>
        </div>
    </div>
