...
if(isset($_POST['but_delete'])){
  ...
  if(isset($_POST['delete'])){
    foreach($_POST['delete'] as $deleteid){
      ...
      $deleteUser = "DELETE from pets WHERE Pid=".$deleteid;
...
<main class="main-content">
 <!-- <div class="col-md-6 col-md-offset-4">
  ...
  <div class="mainpadding">
       <h2 align = "center">The pets that you currently have </h2>
  </div>
  <!-- Form -->
  ...
  <div class="container"> 
    ...
    <table class="table table-borderless" >
     ...
     <?php 
     $query = "SELECT Pid, Pname, Pdob, Psex, Pweight, user FROM pets ";
   ...
   <div class ="mainpadding" align = "center">
    ...
    <input class= "btn btn-outline-danger btn-block" type='submit' value='Delete' name='but_delete'><br><br>
