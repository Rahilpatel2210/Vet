...
if($db)
{
  if(isset($_POST['login_btn']))
  {
      ...
      if($result)
      {
        ...
        {
            // $_SESSION['status']="You are now Loged In";
       ...
       {
              $_SESSION['status']="Username and Password combination incorrect";
                    ...
                    <div class="signin-image">
                      ...
                      <div class="signin-form">
                          ...
                          <label for="your_name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                     <input type="text" name="username" class="textInput" id="your_name" placeholder="Your Name">
                          </div>     
                          <div class="form-group">  
                                       <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>        
                                      <input type="password" name="password" class="textInput" id="your_pass" placeholder="Password">
                           </div> 
                           <div class="form-group">
                            ...
                            <div class="form-group form-button">  
                                     ...
                                     <input type="submit" name="login_btn" class="Log In"  id="signin" class="form-submit" value="Log in">
                            </div>
